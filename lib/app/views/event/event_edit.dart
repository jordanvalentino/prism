...
class EventEdit extends StatefulWidget {
  ...
  final Event _event;
  EventEdit(this._bloc, this._event);

  @override
  _EventEditState createState() => _EventEditState(this._event);
}
...
class _EventEditState extends State<EventEdit> {
  ...
  void initState() {
    ...
    _participantContoller.text = _event.participant.toString();
  ...
  void _save() async {
    ...
    if (replacement.hasCollisionWithEvents(
            globals.activities.events.list, _event) ||
        replacement.hasCollisionWithBusys(globals.busys.list)) {
      dialogs.yesNoDialog(
  ...
  _onConfirmEdit(Event replacement) {
    widget._bloc.update(_event, replacement);
    widget._bloc.eventBloc.updateEventStreamWith(_event);
